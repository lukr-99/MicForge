    ...
    public static void Apply(string name, DspChain c)
    {
        ...
        switch (name)
        {
            case "Broadcast Voice":
                ...
                exc.Enabled = true; exc.Frequency = 4000; exc.Amount = 18;
            ...
            case "Streaming":
                ...
                exc.Enabled = true; exc.Frequency = 4500; exc.Amount = 25;
            ...
            case "Crisp HD":
                ...
                de.Frequency = 7000; de.ThresholdDb = -30; de.Ratio = 4;
                // Clean multiband control with strong exciter for a modern, hi-fi voice.
                mb.Enabled = true; mb.CrossLow = 240; mb.CrossHigh = 3500; mb.Ratio = 2.5; mb.MakeupDb = 1;
                exc.Enabled = true; exc.Frequency = 4000; exc.Amount = 35;
                c.OutputGain.GainDb = 1;
                break;
